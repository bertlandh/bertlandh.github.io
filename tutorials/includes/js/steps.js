$(function(){
  stepCount = 0;
  console.log('%cbertlandhope', 'font-weight: 900; font-size: 40px; color: #f00; text-shadow: 3px 3px 0 #000, 4px 4px 0 #fff; border-bottom: 8px double #f00; padding: 0 8px;');
  console.log('%chttps://youtube.com/c/UCaHRQTSDaH5Wf93u6EWpeew/c/videos', 'font-size: 9px; margin-left: 60px;');
  stepsText = [];
